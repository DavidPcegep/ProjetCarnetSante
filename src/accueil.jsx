    ...
    <div>
        <div className="Content">
          ...
          <div className="logoSection1">
            <a href="/login"><button className="btn"><i><img src={logoGeneralites} alt="logoGeneralites" className="logoGeneralites"/></i><br></br>Généralités</button></a>
          </div>
          ...
          <div className="logoSection2">
            <a href=""><button className="btn"><i><img src={logoGPS} alt="logoGPS" className="logoRessource" /></i><br></br>Ressources</button></a>
          </div>
        </div>
      </div>
  );
